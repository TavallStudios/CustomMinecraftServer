...
final class BedrockGameSessionCoordinator {
    ...
    void handleBatchPayload(ChannelHandlerContext context, ConnectionSession session, BedrockPeerSession peerSession, ByteBuf payload) {
