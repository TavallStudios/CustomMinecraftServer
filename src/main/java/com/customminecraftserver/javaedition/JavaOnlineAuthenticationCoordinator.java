...
final class JavaOnlineAuthenticationCoordinator {
    ...
    JavaOnlineAuthenticationCoordinator(
    ...
    void requestEncryption(ChannelHandlerContext context, ConnectionSession session, JavaLoginDecision decision) {
    ...
    void handleEncryptionResponse(ChannelHandlerContext context, ConnectionSession session, int packetId, ByteBuf frame) {
