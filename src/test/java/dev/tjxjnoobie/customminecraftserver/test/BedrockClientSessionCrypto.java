...
public final class BedrockClientSessionCrypto {
    ...
    public BedrockClientSessionCrypto(PrivateKey privateKey, String serverHandshakeToken) throws Exception {
    ...
    public ByteBuf decryptSinglePacket(ByteBuf payload) {
