...
final class BedrockJwtTestSupport {
    ...
    static String toBase64Der(KeyPair keyPair) {
        return Base64.getEncoder().encodeToString(keyPair.getPublic().getEncoded());
    }

    static String signEs384Jwt(KeyPair keyPair, String x5u, String payloadJson) throws Exception {
    ...
    static String authenticatedIdentityJson(KeyPair clientKey, KeyPair trustedRootKey, KeyPair identityKey) throws Exception {
